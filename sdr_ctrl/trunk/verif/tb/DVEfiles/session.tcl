...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{2 51} {1353 774}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 173} {height 438} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 173} {height 438} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1351} {height 178} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_1" { top.whitebox_intf.sdram_clk top.whitebox_intf.sdr_ras_n top.whitebox_intf.sdr_cas_n top.whitebox_intf.sdr_we_n }
...
catch {gui_list_select -id ${Hier.1} {top.whitebox_intf}}
...
gui_list_show_data -id ${Data.1} {top.whitebox_intf}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {top.whitebox_intf.sdram_clk top.whitebox_intf.sdr_ras_n top.whitebox_intf.sdr_cas_n top.whitebox_intf.sdr_we_n }}
...
gui_open_source -id ${Source.1}  -replace -active _vcs_unit__2727606658 /mnt/vol_NFS_Zener/WD_ESPEC/fparis/MP6134_SDRAM_Controller/sdr_ctrl/trunk/verif/tb/../tb/sdram_interterface.sv
