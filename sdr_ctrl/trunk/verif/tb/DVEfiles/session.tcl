...
# DVE full session
# Saved on Fri Nov 23 22:14:36 2018
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{14 63} {1363 738}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 161} {height 326} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 161} {height 326} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Assertion.1 [gui_create_window -type Assertion -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 137]
gui_set_window_pref_key -window ${Assertion.1} -key dock_width -value_type integer -value -1
gui_set_window_pref_key -window ${Assertion.1} -key dock_height -value_type integer -value 137
gui_set_window_pref_key -window ${Assertion.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Assertion.1} {{left 0} {top 0} {width 1349} {height 136} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1349} {height 105} {dock_state bottom} {dock_on_new_line true}}
