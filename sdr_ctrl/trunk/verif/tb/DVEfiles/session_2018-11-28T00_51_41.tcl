...
# DVE full session
# Saved on Wed Nov 28 00:50:32 2018
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{17 66} {1917 921}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 158} {height 397} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 397
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 158} {height 397} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1900} {height 351} {dock_state bottom} {dock_on_new_line true}}
...
gui_open_source -id ${Source.1}  -replace -active top.test1 /mnt/vol_NFS_Zener/WD_ESPEC/kviquez/MP6134_SDRAM_Controller/sdr_ctrl/trunk/verif/tb/../tb/Test.sv
