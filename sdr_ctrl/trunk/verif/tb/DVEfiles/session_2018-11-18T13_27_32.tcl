...
# DVE full session
# Saved on Sun Nov 18 13:26:36 2018
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{7 51} {1856 780}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 174} {height 443} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 174} {height 443} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 1553} {height 179} {dock_state bottom} {dock_on_new_line false}}
...
gui_sg_addsignal -group "$_session_group_1" { top.u_sdram32.Clk top.u_sdram32.Ras_n top.u_sdram32.Cas_n top.u_sdram32.We_n }

# Global: Highlighting
gui_highlight_signals -color #00ff00 {top.sdram_clk}
...
catch {gui_list_select -id ${Hier.1} {top.u_sdram32}}
...
gui_list_show_data -id ${Data.1} {top.u_sdram32}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {top.u_sdram32.Clk top.u_sdram32.Ras_n top.u_sdram32.Cas_n top.u_sdram32.We_n }}
...
gui_open_source -id ${Source.1}  -replace -active top /mnt/vol_NFS_Zener/WD_ESPEC/fparis/MP6134_SDRAM_Controller/sdr_ctrl/trunk/verif/tb/../tb/tb_top_test.sv
gui_view_scroll -id ${Source.1} -vertical -set 1440
gui_src_set_reusable -id ${Source.1}
# Warning: Class view not found.

# DriverLoad 'DriverLoad.1'
gui_get_drivers -session -id ${DriverLoad.1} -signal top.u_sdram32.Clk -time 10122000 -starttime 10130000
gui_get_drivers -session -id ${DriverLoad.1} -signal top.u_sdram32.Clk -time 9842000 -starttime 9842000
