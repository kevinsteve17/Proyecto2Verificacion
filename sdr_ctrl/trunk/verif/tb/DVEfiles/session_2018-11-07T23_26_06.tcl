...
# DVE full session
# Saved on Wed Nov 7 23:25:01 2018
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{6 55} {1917 921}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1911} {height 261} {dock_state bottom} {dock_on_new_line true}}
...
gui_list_descend -id ${Hier.1} -meta top.test1
